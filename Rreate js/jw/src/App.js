...
import Mui from './mui_lib/Mui';

import 'leaflet/dist/leaflet.css';                                // leaflet CSS 반드시 필요
var jobs = ['DarkMagician',
            'BlueEyesWhiteDragon',
            'RedEyesBlackDragon',
            'Kuriboh',
            'SummonedSkull',
...
function App() {
  ...
  const [party] = useState([
    { job: 'DarkMagician', grade: 'SSR' },
    { job:'Kuriboh', grade: 'SR' },
    { job: 'BlueEyesWhiteDragon', grade: 'S' },
  ]);
  
  const [enemy] = useState([
    { job: 'dorwheldkajfl', grade: 'SSR' },
    { job: 'dorwheldkdhfmsWhrekfl', grade: 'SR' },
    { job: 'dorwheldkdhlsWhrekfl', grade: 'S' },
    { job: 'dorwheldkdhfmsWHrvkf', grade: 'R' },
    { job: 'dorwheldkdhlsWhrvkf', grade: 'H' }
  ]);

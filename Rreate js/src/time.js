...
function RamenTimer({ duration, onComplete }) {
 //const [timeLeft, setTimeLeft] = useState(duration(180);                      // 초기 시간 설정 (3분 = 180초)
  const [timeLeft, setTimeLeft] = useState(duration); // 선택된 라면 시간       // 초기 시간 설정 (3분 = 180초)
  ...
  }, [timeLeft, onComplete]);        //timeLeft가 변할 떄마다 실행 
